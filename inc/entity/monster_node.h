...
struct PathWeight
{
	...
	inline void clear()
	{
		memset(this, 0, sizeof(PathWeight));
	}
...
{
public:
	MonsterNode(float x_, float y_) : x(x_), y(y_), tileDirection(g_game.ingameMapHeight, g_game.ingameMapWidth), tileDistance(g_game.ingameMapHeight, g_game.ingameMapWidth) {}
